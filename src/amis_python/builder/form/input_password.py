...
class InputPassword(FormItem):
    """
    amis InputPassword 密码输入框组件
    对应组件类型: input-password
    文档地址: docs/zh-CN/components/form/input-password.md
    """

    # ==================== 基本属性 ====================
    type: Literal["input-password"] = Field("input-password", description="指定为密码输入框组件")
    ...
    # ==================== 密码输入框特有属性 ====================
    reveal_password: Optional[bool] = Field(None, description="是否展示密码显/隐按钮，默认值为 true")